      ...
      <div className="col-lg-6">
        <div className="card2 card border-0 px-4 py-5">
          ...
          <div className="row px-3"> <label className="mb-1">
            ...
            </label> <input className="mb-4" type="text" name="name" placeholder="Enter Your Full Name" />
             </div>
          ...
          <div className="row mb-3 px-3"><Link to="/admin"> <button type="submit" className="btn btn-blue text-center">Signup</button> </Link></div>
